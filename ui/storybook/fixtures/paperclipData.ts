...
export const storybookAgents: Agent[] = [
  {
    ...
    status: "running",
    reportsTo: "agent-cto",
    capabilities: "Ships full-stack Bizbox product tasks, Storybook coverage, and verification.",
...
export const storybookGoals: Goal[] = [
  {
    ...
    companyId: "company-storybook",
    title: "Build Bizbox",
    description: "Make Bizbox the control plane operators trust for autonomous AI companies.",
    level: "company",
    status: "active",
    parentId: null,
