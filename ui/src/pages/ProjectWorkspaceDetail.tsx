...
const SOURCE_TYPE_OPTIONS: Array<{ value: ProjectWorkspaceSourceType; label: string; description: string }> = [
  { value: "local_path", label: "Local git checkout", description: "A local path Bizbox can use directly." },
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between">
              <div className="space-y-2">
                ...
                <p className="max-w-2xl text-sm text-muted-foreground">
                  Configure the concrete workspace Bizbox attaches to this project. These values drive per-workspace
            ...
            <div className="mt-4 grid gap-4">
              ...
              <details className="rounded-xl border border-dashed border-border/70 bg-background px-3 py-3">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Collapse this unless you need to inspect or edit the raw workspace command model. Bizbox derives Services and Jobs from this JSON.
                </p>
                <div className="mt-3">
