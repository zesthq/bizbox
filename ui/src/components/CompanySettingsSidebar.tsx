...
import { Bot, ChevronLeft, MailPlus, MessageSquare, Settings, Shield, SlidersHorizontal } from "lucide-react";
    ...
    <aside className="w-60 h-full min-h-0 border-r border-border bg-background flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem to="/company/settings/awaiting-human" label="Awaiting Human" icon={MessageSquare} end />
          <SidebarNavItem to="/company/settings/builder" label="AI Builder" icon={Bot} end />
          <SidebarNavItem
