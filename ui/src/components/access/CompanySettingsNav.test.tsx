...
describe("CompanySettingsNav", () => {
  ...
  it("maps company settings routes to the expected shared tab value", () => {
    ...
    expect(getCompanySettingsTab("/company/settings/awaiting-human")).toBe("awaiting-human");
    expect(getCompanySettingsTab("/PAP/company/settings/awaiting-human")).toBe("awaiting-human");
    expect(getCompanySettingsTab("/company/settings/builder")).toBe("builder");
    expect(getCompanySettingsTab("/PAP/company/settings/builder")).toBe("builder");
    ...
    expect(pageTabBarMock).toHaveBeenCalledWith(
      expect.objectContaining({
        ...
        items: [
          ...
          { value: "builder", label: "AI Builder" },
