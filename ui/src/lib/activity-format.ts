...
const ACTIVITY_ROW_VERBS: Record<string, string> = {
  ...
  "issue.awaiting_human.state_reaction": "updated awaiting-human state on",
  "issue.awaiting_human.reply_reaction": "reacted to reply on",
  "issue.awaiting_human.bridge_close_failed": "failed to close awaiting-human bridge on",
...
const ISSUE_ACTIVITY_LABELS: Record<string, string> = {
  ...
  "issue.awaiting_human.state_reaction": "updated the awaiting-human state reaction",
  "issue.awaiting_human.reply_reaction": "reacted to a reply",
  "issue.awaiting_human.bridge_close_failed": "failed to close the awaiting-human bridge",
