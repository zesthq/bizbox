...
- **Agent auth JWT** — Fixed agent auth to fall back to `BETTER_AUTH_SECRET` when `BIZBOX_AGENT_JWT_SECRET` is absent. ([#2866](https://github.com/paperclipai/paperclip/pull/2866), @ergonaworks)
