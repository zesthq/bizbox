...
const capturePath = process.env.BIZBOX_TEST_CAPTURE_PATH;
const statePath = process.env.BIZBOX_TEST_STATE_PATH;
      ...
      const result = await execute({
        ...
        config: {
          ...
          env: {
            ...
            BIZBOX_TEST_STATE_PATH: statePath,
          },
          promptTemplate: "Do work.",
          instructionsFilePath: instructionsFile,
        },
    ...
    try {
      const first = await execute({
        ...
        config: {
          ...
          env: {
            BIZBOX_TEST_CAPTURE_PATH: capturePath1,
          },
          promptTemplate: "Follow the paperclip heartbeat.",
        },
        context: {},
      ...
      const second = await execute({
        ...
        config: {
          ...
          instructionsFilePath: instructionsPath,
          env: {
            BIZBOX_TEST_CAPTURE_PATH: capturePath2,
          },
          promptTemplate: "Follow the paperclip heartbeat.",
        },
        context: {
