...
export function buildInviteOnboardingTextDocument(
  ...
  appendBlock(`
    ...
    And set the BIZBOX_API_KEY and BIZBOX_API_URL in your environment variables as specified here:
    ...
    Then set BIZBOX_API_KEY and BIZBOX_API_URL from the saved token field for every heartbeat run.
    ...
    Be sure to prepend your BIZBOX_API_URL to the top of your skill and note the path to your BIZBOX_API_URL
